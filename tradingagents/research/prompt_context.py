    ...
    return canonical_json(compact_prompt_context({
        ...
        if key not in {"system", "response_schema", "timeout_seconds", "max_output_tokens"}
                         ...
                         or payload.get("reader_revision_policy") in {
                             ...
                             GENERIC_REVISION_POLICY_V5, GENERIC_REVISION_POLICY_V6,
                             GENERIC_REVISION_POLICY_V7, GENERIC_REVISION_POLICY_V8,
                             GENERIC_REVISION_POLICY_V8_PLAIN}),
       ...
       indexed_shared=payload.get("reader_revision_policy") in {
           ...
           GENERIC_REVISION_POLICY_V6, GENERIC_REVISION_POLICY_V7,
           GENERIC_REVISION_POLICY_V8, GENERIC_REVISION_POLICY_V8_PLAIN}))
