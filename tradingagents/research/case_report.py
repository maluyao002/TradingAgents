...
CASE_READER_REQUIREMENTS = (
    ...
    "Use an explicit [source_id] or [fact_id] link only in the paragraph or table row it "
    "actually supports. Do not add source links to every paragraph, and do not repeat a "
