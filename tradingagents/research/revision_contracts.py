...
from .reader_revision import (
    ...
    GENERIC_REVISION_POLICY_V8,
    GENERIC_REVISION_POLICY_V8_PLAIN,
    ...
    GENERIC_V8_COVERAGE_REQUIREMENTS,
    GENERIC_V8_FOLLOWUP_REQUIREMENTS,
    GENERIC_V8_PLAIN_COVERAGE_REQUIREMENTS,
...
_V6_HASH_CONTENT = {
    **_V5_HASH_CONTENT,
    ...
    "source_witness_policy": GENERIC_V6_SOURCE_WITNESS_POLICY,
}
...
_V8_HASH_CONTENT = {
    **_V7_HASH_CONTENT,
    "policy": GENERIC_REVISION_POLICY_V8,
    "writer_requirements": GENERIC_V8_WRITER_REQUIREMENTS,
    "factual_requirements": GENERIC_V8_FOLLOWUP_REQUIREMENTS,
    "coverage_requirements": GENERIC_V8_COVERAGE_REQUIREMENTS,
    "inventory_temporal_finding_policy": "complete-receipt-scopes-exact-procedural-finding-v1",
}
V8_CONTRACT = RevisionContract(
    GENERIC_REVISION_POLICY_V8, digest(_V8_HASH_CONTENT), GENERIC_V8_WRITER_REQUIREMENTS,
    GENERIC_V8_FOLLOWUP_REQUIREMENTS, GENERIC_V8_COVERAGE_REQUIREMENTS,
    GENERIC_V6_SOURCE_WITNESS_POLICY, True,
)
_V8_PLAIN_HASH_CONTENT = {
    key: value for key, value in _V8_HASH_CONTENT.items()
    if key != "controlled_disclosure_policy"
}
_V8_PLAIN_HASH_CONTENT["policy"] = GENERIC_REVISION_POLICY_V8_PLAIN
_V8_PLAIN_HASH_CONTENT["writer_requirements"] = GENERIC_V8_PLAIN_WRITER_REQUIREMENTS
_V8_PLAIN_HASH_CONTENT["factual_requirements"] = GENERIC_V8_PLAIN_FOLLOWUP_REQUIREMENTS
_V8_PLAIN_HASH_CONTENT["coverage_requirements"] = GENERIC_V8_PLAIN_COVERAGE_REQUIREMENTS
V8_PLAIN_CONTRACT = RevisionContract(
    GENERIC_REVISION_POLICY_V8_PLAIN, digest(_V8_PLAIN_HASH_CONTENT),
    GENERIC_V8_PLAIN_WRITER_REQUIREMENTS, GENERIC_V8_PLAIN_FOLLOWUP_REQUIREMENTS,
    GENERIC_V8_PLAIN_COVERAGE_REQUIREMENTS, GENERIC_V6_SOURCE_WITNESS_POLICY, True,
)
TEMPORAL_SCOPE_CONTRACTS = (V8_CONTRACT, V8_PLAIN_CONTRACT)
PINNED_CONTRACTS = (V5_CONTRACT, V6_CONTRACT, V7_CONTRACT, *TEMPORAL_SCOPE_CONTRACTS)
PINNED_POLICIES = frozenset(contract.policy for contract in PINNED_CONTRACTS)
INVENTORY_CONTRACTS = (V6_CONTRACT, V7_CONTRACT, *TEMPORAL_SCOPE_CONTRACTS)
INVENTORY_POLICIES = frozenset(contract.policy for contract in INVENTORY_CONTRACTS)
DISCLOSURE_CONTRACTS = (V7_CONTRACT, V8_CONTRACT)
DISCLOSURE_POLICIES = frozenset(contract.policy for contract in DISCLOSURE_CONTRACTS)
DISCLOSURE_CONTRACT_HASHES = frozenset(contract.sha256 for contract in DISCLOSURE_CONTRACTS)
...
def revision_contract(policy: str, sha256: str) -> RevisionContract:
    ...
    for contract in (V3_CONTRACT, V4_CONTRACT, V5_CONTRACT, V6_CONTRACT,
                     V7_CONTRACT, *TEMPORAL_SCOPE_CONTRACTS):
